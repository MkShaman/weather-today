<template>
  <div class="w-full">
        ...
        <div class="flex flex-col">
          ...
          <div class="my-6">
            <div class="flex flex-row items-center justify-center space-x-4">
              ...
              <div id="temp">
                <h4 class="text-4xl">{{ day.day.avgtemp_c }}&deg;C</h4>
                <h5 class="heading-5 mt-2 text-base md:mt-0">
                  {{ day.day.mintemp_c }}<sup>℃</sup> - {{ day.day.maxtemp_c }}<sup>℃</sup>
                </h5>
	...
	c0,0.24-0.08,0.44-0.24,0.6c-0.16,0.17-0.35,0.25-0.59,0.25c-0.24,0-0.44-0.08-0.6-0.25C17.5,21.45,17.41,21.25,17.41,21.02z"
                ...
                <p class="text-base text-gray-700">{{ day.day.condition.text }}</p>

                <p class="text-base text-gray-700">Humidity {{ day.day.avghumidity }}%</p>
              </div>
            </div>
          </div>
